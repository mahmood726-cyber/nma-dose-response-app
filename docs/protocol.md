        # Nma Dose Response App: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/nma-dose-response-app.git

        ## Objective

        NMA Dose Response App combines network meta-analysis with dose-response modelling, enabling simultaneous estimation of comparative effectiveness and dose-response relationships.
        ...
        - Code: https://github.com/mahmood726-cyber/nma-dose-response-app.git
